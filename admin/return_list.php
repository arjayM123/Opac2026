...
<style>
    ...
    .table thead th {
        ...
        background-color:rgb(92, 152, 212);
        color: #495057;
    }
...
<div class="main-content">
    <div class="form-container">
        <h3 class="mt-4">Returned Books</h3>
            ...
            <tbody>
                ...
                while ($row = $borrowed->fetch_assoc()):
                    ...
                    if ($is_overdue && $row['status'] == 'borrowed') {
                        $conn->query("UPDATE borrowers SET return_status = 'overdue' WHERE id = " . $row['id']);
                        $row['status'] = 'overdue';
                    }
                ?>
                    <tr>
